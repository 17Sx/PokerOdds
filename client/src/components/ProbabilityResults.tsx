...
const ProbabilityResults: React.FC<ProbabilityResultsProps> = ({ results, loading }) => {
  if (loading) {
    return (
      <div className="glass p-6 rounded-xl shadow-lg backdrop-blur-md animate-pulse glow-subtle">
        <div className="h-6 bg-white/5 rounded-xl mb-4 w-1/2"></div>
        <div className="h-4 bg-white/5 rounded-xl mb-2 w-full"></div>
        <div className="h-4 bg-white/5 rounded-xl mb-2 w-3/4"></div>
        <div className="h-4 bg-white/5 rounded-xl mb-2 w-5/6"></div>
      </div>
    );
  }
  ...
  return (
    <div>
      <h3 className="text-2xl font-bold mb-6 text-white text-center border-b border-white/10 pb-4 w-full">
        Results
      </h3>
      
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row gap-6">
          <div className="glass-card flex-1 p-6 rounded-xl bg-white/5 hover:bg-white/10 flex flex-col items-center min-h-[150px] justify-center">
            ...
            <div className="w-full text-center overflow-hidden px-2">
              <p className="text-xl sm:text-2xl font-bold text-white whitespace-normal break-words">{results.winProbability}%</p>
            </div>
          </div>
          ...
          <div className="glass-card flex-1 p-6 rounded-xl bg-white/5 hover:bg-white/10 flex flex-col items-center min-h-[150px] justify-center">
            ...
            <div className="w-full text-center overflow-hidden px-2">
              <p className="text-xl sm:text-2xl font-bold text-white whitespace-normal break-words">{results.tieProbability}%</p>
            </div>
          </div>
          ...
          <div className="glass-card flex-1 p-6 rounded-xl bg-white/5 hover:bg-white/10 flex flex-col items-center min-h-[150px] justify-center">
            ...
            <div className="w-full text-center overflow-hidden px-2">
              <p className="text-xl sm:text-2xl font-bold text-white whitespace-normal break-words">{results.lossProbability}%</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {results.currentHand && (
        <div className="mb-8 glass-card p-5 rounded-xl bg-white/5 hover:bg-white/10">
      ...
      {results.outs && results.outs.length > 0 && (
        <div className="glass-card p-5 rounded-xl bg-white/5 hover:bg-white/10">
